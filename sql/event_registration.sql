...
CREATE TYPE "reg_status" AS ENUM ( --should look on this
	'pending',
	'confirmed',
	'cancelled',
	'waitlisted',
...
CREATE TYPE "Registrations_payment_status" AS ENUM (
	...
	'paid',
	'refunded',
	'cancelled' -- should look on this i removed double c
);
...
CREATE TABLE "Event_categories" (
	"event_categories_id" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,--i changed the Event_categories_(Id) to id
	"name" VARCHAR(255),
	"description" TEXT,
...
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Events"
ADD FOREIGN KEY("organizer_id") REFERENCES "Event_organizers"("event_organizers_id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Events"
ADD FOREIGN KEY("event_categories_id") REFERENCES "Event_categories"("event_categories_id")
